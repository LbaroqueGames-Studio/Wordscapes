...
namespace BizzyBeeGames.WordBlocks
{
	public class RainDropSlow : SpawnObject
	{
		...
		[SerializeField] private float shrinkRate			= 0f;
		[SerializeField] private float minShrinkSize		= 0f;

		[Space]

		[SerializeField] private float rainDropStayDuration	= 0f;
		[SerializeField] private float rainDropFadeDuration	= 0f;
		[SerializeField] private float rainDropSpacing		= 0f;
		[SerializeField] private float rainDropScaleDown	= 0f;
		[SerializeField] private float rainDropOffset		= 0f;

		[SerializeField] private Image rainDropPrefab		= null;
