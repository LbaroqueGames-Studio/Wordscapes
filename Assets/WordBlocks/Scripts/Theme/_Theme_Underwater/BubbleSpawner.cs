...
namespace BizzyBeeGames.WordBlocks
{
	public class BubbleSpawner : ObjectSpawner
	{
		...
		[SerializeField] private int	minBubbleGroupSize;
		[SerializeField] private int	maxBubbleGroupSize;
		[SerializeField] private float	minBubbleOffset;
		[SerializeField] private float	maxBubbleOffset;
