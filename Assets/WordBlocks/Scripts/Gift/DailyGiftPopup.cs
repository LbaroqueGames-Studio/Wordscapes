...
namespace BizzyBeeGames.WordBlocks
{
	public class DailyGiftPopup : Popup
	{
		...
		[SerializeField] private List<GiftBox>		giftBoxes		= null;
		[SerializeField] private Transform			giftAnimMarker	= null;
		[SerializeField] private AnimationCurve		giftAnimCurve	= null;
