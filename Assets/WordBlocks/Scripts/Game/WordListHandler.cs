...
namespace BizzyBeeGames.WordBlocks
{
	public class WordListHandler : UIMonoBehaviour
	{
		...
		[SerializeField] private WordLetterTile	letterTilePrefab = null;

		[Tooltip("The amount of space between each of the tiles.")]
		[SerializeField] private float spaceBetweenLetters = 2f;

		[Tooltip("The amount of space between each group of tiles that make up a word.")]
		[SerializeField] private float spaceBetweenWords = 15f;

		[Tooltip("The amount of space between each row of tiles.")]
		[SerializeField] private float spaceBetweenRows = 15f;
		...
		[SerializeField] private List<TileSizeInfo> tileSizes = null;
