...
namespace BizzyBeeGames.WordBlocks
{
	public class BoardCreator : MonoBehaviour
	{
		...
		private static WorkerBehaviour activeWorkerBehaviour;
		...
		{
			if (activeWorkerBehaviour != null)
			{
				activeWorkerBehaviour.Abort();
			}
			...
			activeWorkerBehaviour = WorkerBehaviour.StartWorker(boardCreatorWorker, (Worker worker) =>
			{
				activeWorkerBehaviour = null;
