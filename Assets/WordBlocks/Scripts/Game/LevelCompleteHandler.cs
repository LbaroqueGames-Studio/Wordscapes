...
namespace BizzyBeeGames.WordBlocks
{
	...
	public class LevelCompleteHandler : MonoBehaviour
	{
		...
		[SerializeField] private Slider			rewardProgressSlider	= null;
		[SerializeField] private GameObject		coinContainer			= null;
		[SerializeField] private RectTransform	coinMarker				= null;
		[SerializeField] private Text			coinAmountText			= null;
		[SerializeField] private float			fadeInAnimDuration		= 0;
		[SerializeField] private float			progressBarAnimDuration	= 0;
		...
		public void ShowLevelComplete(int completedLevelNumber, bool nextLevelCompleted)
		{
			...
			nextLevelText.text = "LEVEL " + (GameManager.Instance.LastCompletedLevel + 1);
